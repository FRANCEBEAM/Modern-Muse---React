...
function About() {
  return (
    <div className='about-container'>
        <div className='wrapper px-4 h-[60vh] pt-10 md:h-[50vh] lg:grid lg:grid-cols-2 lg:pt-20'>
          ...
          <div className='right-content pt-10 lg:p-0'>
            <h1 className='text-[#D4D4D4] font-extrabold text-5xl pb-3 lg:text-6xl'>About</h1>
